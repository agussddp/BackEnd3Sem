...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdComentarioEvento).HasName("PK__Comentar__4305A1F13CF02820");
        ...
        {
            entity.HasKey(e => e.IdEvento).HasName("PK__Evento__034EFC04A9BB3A2A");
        ...
        {
            entity.HasKey(e => e.IdInstituicao).HasName("PK__Institui__B771C0D8181C7754");
        ...
        {
            entity.HasKey(e => e.IdPresenca).HasName("PK__Presenca__50FB6F5D7A194638");
        ...
        {
            entity.HasKey(e => e.IdTipoEvento).HasName("PK__TipoEven__CDB3A3BE26A10708");
        ...
        {
            entity.HasKey(e => e.IdTipoUsuario).HasName("PK__TipoUsua__CA04062BD86D530D");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF97B92BB52D");
